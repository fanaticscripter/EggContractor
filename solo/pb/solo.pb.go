...
type SoloContract struct {
	...
	LastRefreshedTimestamp         float64 `protobuf:"fixed64,10,opt,name=last_refreshed_timestamp,json=lastRefreshedTimestamp,proto3" json:"last_refreshed_timestamp,omitempty"`
}
...
func (x *SoloContract) GetLastRefreshedTimestamp() float64 {
	if x != nil {
		return x.LastRefreshedTimestamp
	}
	return 0
}
...
var file_solo_pb_solo_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x6e, 0x65, 0x12, 0x38, 0x0a, 0x18, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x66,
	0x72, 0x65, 0x73, 0x68, 0x65, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x01, 0x52, 0x16, 0x6c, 0x61, 0x73, 0x74, 0x52, 0x65, 0x66, 0x72,
	0x65, 0x73, 0x68, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x32,
