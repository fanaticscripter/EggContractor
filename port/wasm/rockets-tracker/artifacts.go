...
var _craftingCostInfo = map[artifactClassTier]craftingCostParams{
	{api.ArtifactSpec_LUNAR_TOTEM, 2}:          {47.913866, 4.791387, 300, 0.2},
	{api.ArtifactSpec_LUNAR_TOTEM, 3}:          {4749.233211, 474.923321, 300, 0.2},
	{api.ArtifactSpec_LUNAR_TOTEM, 4}:          {28986.362702, 2898.636270, 300, 0.2},
	{api.ArtifactSpec_NEODYMIUM_MEDALLION, 2}:  {3982.334085, 398.233409, 300, 0.2},
	{api.ArtifactSpec_NEODYMIUM_MEDALLION, 3}:  {16466.275749, 1646.627575, 300, 0.2},
	{api.ArtifactSpec_NEODYMIUM_MEDALLION, 4}:  {58753.389780, 5875.338978, 300, 0.2},
	{api.ArtifactSpec_BEAK_OF_MIDAS, 2}:        {6075.334222, 607.533422, 300, 0.2},
	{api.ArtifactSpec_BEAK_OF_MIDAS, 3}:        {23885.787138, 2388.578714, 300, 0.2},
	{api.ArtifactSpec_BEAK_OF_MIDAS, 4}:        {86083.096922, 8608.309692, 300, 0.2},
	{api.ArtifactSpec_LIGHT_OF_EGGENDIL, 2}:    {67892.952668, 6789.295267, 300, 0.2},
	{api.ArtifactSpec_LIGHT_OF_EGGENDIL, 3}:    {168121.517425, 16812.151743, 300, 0.2},
	{api.ArtifactSpec_LIGHT_OF_EGGENDIL, 4}:    {330068.881399, 33006.888140, 300, 0.2},
	{api.ArtifactSpec_DEMETERS_NECKLACE, 2}:    {383.059174, 38.305917, 300, 0.2},
	{api.ArtifactSpec_DEMETERS_NECKLACE, 3}:    {7628.255210, 762.825521, 300, 0.2},
	{api.ArtifactSpec_DEMETERS_NECKLACE, 4}:    {41267.360175, 4126.736017, 300, 0.2},
	{api.ArtifactSpec_VIAL_MARTIAN_DUST, 2}:    {3302.979512, 330.297951, 300, 0.2},
	{api.ArtifactSpec_VIAL_MARTIAN_DUST, 3}:    {26353.836098, 2635.383610, 300, 0.2},
	{api.ArtifactSpec_VIAL_MARTIAN_DUST, 4}:    {139253.590590, 13925.359059, 300, 0.2},
	{api.ArtifactSpec_ORNATE_GUSSET, 2}:        {5167.170022, 516.717002, 300, 0.2},
	{api.ArtifactSpec_ORNATE_GUSSET, 3}:        {28986.362702, 2898.636270, 300, 0.2},
	{api.ArtifactSpec_ORNATE_GUSSET, 4}:        {163774.023981, 16377.402398, 300, 0.2},
	{api.ArtifactSpec_THE_CHALICE, 2}:          {8798.389852, 879.838985, 300, 0.2},
	{api.ArtifactSpec_THE_CHALICE, 3}:          {30365.963161, 3036.596316, 300, 0.2},
	{api.ArtifactSpec_THE_CHALICE, 4}:          {139253.590590, 13925.359059, 300, 0.2},
	{api.ArtifactSpec_BOOK_OF_BASAN, 2}:        {114405.161123, 11440.516112, 300, 0.2},
	{api.ArtifactSpec_BOOK_OF_BASAN, 3}:        {360472.914183, 36047.291418, 300, 0.2},
	{api.ArtifactSpec_BOOK_OF_BASAN, 4}:        {934701.796280, 93470.179628, 300, 0.2},
	{api.ArtifactSpec_PHOENIX_FEATHER, 2}:      {16466.275749, 1646.627575, 300, 0.2},
	{api.ArtifactSpec_PHOENIX_FEATHER, 3}:      {50473.355229, 5047.335523, 300, 0.2},
	{api.ArtifactSpec_PHOENIX_FEATHER, 4}:      {237296.526000, 23729.652600, 300, 0.2},
	{api.ArtifactSpec_TUNGSTEN_ANKH, 2}:        {3982.334085, 398.233409, 300, 0.2},
	{api.ArtifactSpec_TUNGSTEN_ANKH, 3}:        {25099.583520, 2509.958352, 300, 0.2},
	{api.ArtifactSpec_TUNGSTEN_ANKH, 4}:        {110546.051566, 11054.605157, 300, 0.2},
	{api.ArtifactSpec_AURELIAN_BROOCH, 2}:      {1186.987877, 118.698788, 300, 0.2},
	{api.ArtifactSpec_AURELIAN_BROOCH, 3}:      {13827.006446, 1382.700645, 300, 0.2},
	{api.ArtifactSpec_AURELIAN_BROOCH, 4}:      {58753.389780, 5875.338978, 300, 0.2},
	{api.ArtifactSpec_CARVED_RAINSTICK, 2}:     {10082.597699, 1008.259770, 300, 0.2},
	{api.ArtifactSpec_CARVED_RAINSTICK, 3}:     {39572.068752, 3957.206875, 300, 0.2},
	{api.ArtifactSpec_CARVED_RAINSTICK, 4}:     {168121.517425, 16812.151743, 300, 0.2},
	{api.ArtifactSpec_PUZZLE_CUBE, 2}:          {90.580782, 9.058078, 300, 0.2},
	{api.ArtifactSpec_PUZZLE_CUBE, 3}:          {14672.717776, 1467.271778, 300, 0.2},
	{api.ArtifactSpec_PUZZLE_CUBE, 4}:          {110353.422196, 11035.342220, 300, 0.2},
	{api.ArtifactSpec_QUANTUM_METRONOME, 2}:    {18400.435579, 1840.043558, 300, 0.2},
	{api.ArtifactSpec_QUANTUM_METRONOME, 3}:    {67892.952668, 6789.295267, 300, 0.2},
	{api.ArtifactSpec_QUANTUM_METRONOME, 4}:    {306621.058816, 30662.105882, 300, 0.2},
	{api.ArtifactSpec_SHIP_IN_A_BOTTLE, 2}:     {36322.087764, 3632.208776, 300, 0.2},
	{api.ArtifactSpec_SHIP_IN_A_BOTTLE, 3}:     {113895.404464, 11389.540446, 300, 0.2},
	{api.ArtifactSpec_SHIP_IN_A_BOTTLE, 4}:     {442510.337308, 44251.033731, 300, 0.2},
	{api.ArtifactSpec_TACHYON_DEFLECTOR, 2}:    {77412.173390, 7741.217339, 300, 0.2},
	{api.ArtifactSpec_TACHYON_DEFLECTOR, 3}:    {259516.135935, 25951.613593, 300, 0.2},
	{api.ArtifactSpec_TACHYON_DEFLECTOR, 4}:    {1220591.960920, 122059.196092, 300, 0.2},
	{api.ArtifactSpec_INTERSTELLAR_COMPASS, 2}: {9425.903017, 942.590302, 300, 0.2},
	{api.ArtifactSpec_INTERSTELLAR_COMPASS, 3}: {37923.865687, 3792.386569, 300, 0.2},
	{api.ArtifactSpec_INTERSTELLAR_COMPASS, 4}: {226570.172702, 22657.017270, 300, 0.2},
	{api.ArtifactSpec_DILITHIUM_MONOCLE, 2}:    {24487.669756, 2448.766976, 300, 0.2},
	{api.ArtifactSpec_DILITHIUM_MONOCLE, 3}:    {80590.781591, 8059.078159, 300, 0.2},
	{api.ArtifactSpec_DILITHIUM_MONOCLE, 4}:    {271970.137871, 27197.013787, 300, 0.2},
	{api.ArtifactSpec_TITANIUM_ACTUATOR, 2}:    {26353.836098, 2635.383610, 300, 0.2},
	{api.ArtifactSpec_TITANIUM_ACTUATOR, 3}:    {88920.446829, 8892.044683, 300, 0.2},
	{api.ArtifactSpec_TITANIUM_ACTUATOR, 4}:    {215900.725714, 21590.072571, 300, 0.2},
	{api.ArtifactSpec_MERCURYS_LENS, 2}:        {7084.307300, 708.430730, 300, 0.2},
	{api.ArtifactSpec_MERCURYS_LENS, 3}:        {30365.963161, 3036.596316, 300, 0.2},
	{api.ArtifactSpec_MERCURYS_LENS, 4}:        {295510.569713, 29551.056971, 300, 0.2},
	{api.ArtifactSpec_TACHYON_STONE, 2}:        {495.936563, 49.593656, 300, 0.2},
	{api.ArtifactSpec_TACHYON_STONE, 3}:        {18048.119505, 1804.811950, 300, 0.2},
	{api.ArtifactSpec_TACHYON_STONE, 4}:        {236946.431795, 23694.643179, 300, 0.2},
	{api.ArtifactSpec_DILITHIUM_STONE, 2}:      {19671.158436, 1967.115844, 300, 0.2},
	{api.ArtifactSpec_DILITHIUM_STONE, 3}:      {82572.111552, 8257.211155, 300, 0.2},
	{api.ArtifactSpec_DILITHIUM_STONE, 4}:      {459362.657726, 45936.265773, 300, 0.2},
	{api.ArtifactSpec_SHELL_STONE, 2}:          {262.014460, 26.201446, 300, 0.2},
	{api.ArtifactSpec_SHELL_STONE, 3}:          {18048.119505, 1804.811950, 300, 0.2},
	{api.ArtifactSpec_SHELL_STONE, 4}:          {183125.193310, 18312.519331, 300, 0.2},
	{api.ArtifactSpec_LUNAR_STONE, 2}:          {406.733739, 40.673374, 300, 0.2},
	{api.ArtifactSpec_LUNAR_STONE, 3}:          {12447.661756, 1244.766176, 300, 0.2},
	{api.ArtifactSpec_LUNAR_STONE, 4}:          {155125.282426, 15512.528243, 300, 0.2},
	{api.ArtifactSpec_SOUL_STONE, 2}:           {5196.192180, 519.619218, 300, 0.2},
	{api.ArtifactSpec_SOUL_STONE, 3}:           {64770.664593, 6477.066459, 300, 0.2},
	{api.ArtifactSpec_SOUL_STONE, 4}:           {250022.006603, 25002.200660, 300, 0.2},
	{api.ArtifactSpec_PROPHECY_STONE, 2}:       {50259.443610, 5025.944361, 300, 0.2},
	{api.ArtifactSpec_PROPHECY_STONE, 3}:       {246536.331347, 24653.633135, 300, 0.2},
	{api.ArtifactSpec_PROPHECY_STONE, 4}:       {731674.386774, 73167.438677, 300, 0.2},
	{api.ArtifactSpec_QUANTUM_STONE, 2}:        {7252.777969, 725.277797, 300, 0.2},
	{api.ArtifactSpec_QUANTUM_STONE, 3}:        {25118.095517, 2511.809552, 300, 0.2},
	{api.ArtifactSpec_QUANTUM_STONE, 4}:        {228278.681628, 22827.868163, 300, 0.2},
	{api.ArtifactSpec_TERRA_STONE, 2}:          {5196.192180, 519.619218, 300, 0.2},
	{api.ArtifactSpec_TERRA_STONE, 3}:          {29988.962680, 2998.896268, 300, 0.2},
	{api.ArtifactSpec_TERRA_STONE, 4}:          {303837.601247, 30383.760125, 300, 0.2},
	{api.ArtifactSpec_LIFE_STONE, 2}:           {10507.145320, 1050.714532, 300, 0.2},
	{api.ArtifactSpec_LIFE_STONE, 3}:           {63177.402252, 6317.740225, 300, 0.2},
	{api.ArtifactSpec_LIFE_STONE, 4}:           {325027.911927, 32502.791193, 300, 0.2},
	{api.ArtifactSpec_CLARITY_STONE, 2}:        {36603.479778, 3660.347978, 300, 0.2},
	{api.ArtifactSpec_CLARITY_STONE, 3}:        {185026.382927, 18502.638293, 300, 0.2},
	{api.ArtifactSpec_CLARITY_STONE, 4}:        {774986.051383, 77498.605138, 300, 0.2},
	{api.ArtifactSpec_GOLD_METEORITE, 2}:       {3982.530000, 398.253000, 300, 0.2},
	{api.ArtifactSpec_GOLD_METEORITE, 3}:       {31373.351250, 3137.335125, 300, 0.2},
	{api.ArtifactSpec_TAU_CETI_GEODE, 2}:       {7867.320000, 786.732000, 300, 0.2},
	{api.ArtifactSpec_TAU_CETI_GEODE, 3}:       {53149.830000, 5314.983000, 300, 0.2},
	{api.ArtifactSpec_SOLAR_TITANIUM, 2}:       {3753.000000, 375.300000, 300, 0.2},
	{api.ArtifactSpec_SOLAR_TITANIUM, 3}:       {37794.360000, 3779.436000, 300, 0.2},
}
